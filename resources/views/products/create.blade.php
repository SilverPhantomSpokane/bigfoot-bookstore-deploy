...
<div class="max-w-xl mx-auto bg-white p-6 rounded-xl shadow">
    <h1 class="text-2xl font-bold text-gray-800 mb-4">Add New Product</h1>
<form action="{{ route('departments.products.store', $department) }}" method="POST" enctype="multipart/form-data">  
        ...
        <p class="mb-2 text-gray-700">{{ ucfirst($department->name) }}</p>
